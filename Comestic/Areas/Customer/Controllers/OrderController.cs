...
namespace Comestic.Areas.Customer.Controllers
{
    [Area("Customer")]
    public class OrderController : Controller
    {
        ...
        [Authorize(Roles = SD.ManagerUser+"," +SD.EmployeeUser)]
        ...
        [Authorize(Roles = SD.EmployeeUser + "," + SD.ManagerUser)]
        ...
        [Authorize]
        public async Task<IActionResult> Ordered(int productPage = 1, string searchEmail = null, string searchPhone = null, string searchName = null)
        {
            ...
            if (searchName != null || searchEmail != null || searchPhone != null)
            {
                ...
                if (searchName != null)
                {
                    OrderHeaderList = await _db.OrderHeader.Include(o => o.ApplicationUser)
                                                .Where(u => u.Comments.ToLower().Contains(searchName.ToLower()))
